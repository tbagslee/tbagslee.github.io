...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-f50861","is-html-f50861","is-jsdelivr-f50861","is-gtm-f50861","is-gravatar-f50861","is-theme-f50861","is-json-f50861"];
      return Promise.all(
        names
