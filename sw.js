...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-f61a1e","is-html-f61a1e","is-jsdelivr-f61a1e","is-gtm-f61a1e","is-gravatar-f61a1e","is-theme-f61a1e","is-json-f61a1e"];
      return Promise.all(
        names
