...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-0e0a94","is-html-0e0a94","is-jsdelivr-0e0a94","is-gtm-0e0a94","is-gravatar-0e0a94","is-theme-0e0a94","is-json-0e0a94"];
      return Promise.all(
        names
