...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-ccfc44","is-html-ccfc44","is-jsdelivr-ccfc44","is-gtm-ccfc44","is-gravatar-ccfc44","is-theme-ccfc44","is-json-ccfc44"];
      return Promise.all(
        names
