...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-2039e3","is-html-2039e3","is-jsdelivr-2039e3","is-gtm-2039e3","is-gravatar-2039e3","is-theme-2039e3","is-json-2039e3"];
      return Promise.all(
        names
