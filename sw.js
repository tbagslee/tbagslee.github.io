...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-6cce0e","is-html-6cce0e","is-jsdelivr-6cce0e","is-gtm-6cce0e","is-gravatar-6cce0e","is-theme-6cce0e","is-json-6cce0e"];
      return Promise.all(
        names
