...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-9984b2","is-html-9984b2","is-jsdelivr-9984b2","is-gtm-9984b2","is-gravatar-9984b2","is-theme-9984b2","is-json-9984b2"];
      return Promise.all(
        names
