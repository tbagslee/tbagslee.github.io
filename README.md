...
- 托管服务：[GitHub Pages](https://pages.github.com) + [Gitee Pages](https://gitee.com/)
...
- 其他网址： [Subtle Patterns | 背景纹理图](https://www.toptal.com/designers/subtlepatterns/) + [阿里图标库](https://www.iconfont.cn/search/index?searchType=icon&q=zhihu) + [hexo官方文档](https://hexo.io/docs) + [git官网](https://git-scm.com/) + [Node.js](https://nodejs.org/en/) + [jsDelivr](https://www.jsdelivr.com/)
